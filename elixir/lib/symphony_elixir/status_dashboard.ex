defmodule SymphonyElixir.StatusDashboard do
  ...
  defp tracker_url(%{kind: "github", repository: repository}) when is_binary(repository) and repository != "" do
    "https://github.com/#{repository}/issues"
  end

  defp tracker_url(%{project_slug: project_slug}) when is_binary(project_slug) and project_slug != "" do
    "https://linear.app/project/#{project_slug}/issues"
  end

  defp tracker_url(_tracker), do: nil
